...
// ---------------------------------------------------------------------------
// Recipe schemas (kept from existing, recipes are hand-maintained)
// ---------------------------------------------------------------------------
...
const RecipeSectionSchema = z.discriminatedUnion('type', [
...
export const RecipeDefSchema = z.object({
  ...
  title: z.string(),
  description: z.string(),
  level: z.enum(['atom', 'foundation', 'molecule', 'organism', 'page']),
...
export const OverviewSchema = z.object({
  ...
  component_categories: z.record(z.string(), z.string()),
});
